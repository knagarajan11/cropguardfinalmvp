...
IMAGE_DIR = "/workspace/cropguard_eval_images1"

RESULTS_CSV = "/workspace/cropguard_base_vs_lora_results.csv"
METRICS_CSV = "/workspace/cropguard_base_vs_lora_metrics.csv"
...
print("=" * 80)
print("STEP 1: FIND 6 EVALUATION IMAGES")
print("=" * 80)
print()
...
def match_label(text):
    ...
    if "common_rust" in text:
        return "common rust"

    if "northern_leaf_blight" in text:
...
if len(evaluation_images) != 6:

    raise RuntimeError(
        "Expected exactly 6 labelled evaluation images."
    )
...
Use one of the five disease classes listed above.
