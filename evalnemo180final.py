...
# =============================================================================
# CROPGUARD - NEMOTRON 180-IMAGE BASE vs BASE+LoRA EVALUATION
# =============================================================================
#
# Purpose:
...
IMAGE_DIR = (
    "/workspace/gsh-team03/CropGuard/images180/"
    "eval_cosmos3_180"
)

RESULTS_CSV = "/workspace/cropguard_nemotron_180_base_vs_lora_results.csv"
...
EXPECTED_TOTAL_IMAGES = 180
EXPECTED_IMAGES_PER_CLASS = 30
...
print()
print("=" * 88)
print("        CROPGUARD NEMOTRON 180-IMAGE BASE vs BASE+LoRA EVALUATION")
print("=" * 88)
print()
...
print("  180 images = 6 classes x 30 images")
...
# =============================================================================
# STEP 1: FIND AND VALIDATE EXACTLY 180 IMAGES
# =============================================================================

print("=" * 88)
print("STEP 1: FIND AND VALIDATE 180 IMAGES")
print("=" * 88)
print()
...
if bad_counts:
    raise RuntimeError(
        "Dataset is not balanced at 30 images per class: "
        + str(bad_counts)
    )
...
def run_generation(inputs, label):
    ...
    try:
        ...
        print(f"[{label}] GENERATION FAILED: {repr(exc)}")
        traceback.print_exc()

        return "", inference_time, False, repr(exc)
...
# =============================================================================
# STEP 6: RUN ALL 180 IMAGES
# =============================================================================

print("=" * 88)
print("STEP 6: RUN 180 IMAGES - BASE + BASE LoRA")
print("=" * 88)
print()
...
print("=" * 88)
print("CROPGUARD NEMOTRON 180-IMAGE EVALUATION COMPLETE")
print("=" * 88)
print()
