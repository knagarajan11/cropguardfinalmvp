...
# =============================================================================
# CROPGUARD - NEMOTRON 100-IMAGE BASE vs BASE+LoRA EVALUATION
# =============================================================================
#
# Purpose:
#   Evaluate the same 100-image dataset with:
#       1. Nemotron Base
...
IMAGE_DIR = "/workspace/gsh-team03/images100/eval_nemotron_100_final"
RESULTS_CSV = "/workspace/cropguard_nemotron_100_base_vs_lora_results.csv"
...
print()
print("=" * 88)
print("        CROPGUARD NEMOTRON 100-IMAGE BASE vs BASE+LoRA EVALUATION")
print("=" * 88)
print()
...
print("  120 images = 5 classes x 20 images")
...
def normalize_folder_label(folder_name):
    """
    Convert PlantVillage-style folder names to one of the five disease labels.
...
# =============================================================================
# STEP 1: FIND AND VALIDATE EXACTLY 100 IMAGES
# =============================================================================

print("=" * 88)
print("STEP 1: FIND AND VALIDATE 100 IMAGES")
print("=" * 88)
print()
...
for image_path in all_images:
    ...
    if ground_truth not in LABELS:
        raise RuntimeError(
            f"Could not identify one of the five ground-truth classes for:\n"
            f"{image_path}"
        )
...
The evaluation has exactly five possible disease classes:
...
IMPORTANT:
- Select exactly ONE of the five classes.
- At the end of your response, give the final answer as a number from 1 to 5.
...
# =============================================================================
# STEP 6: RUN ALL 100 IMAGES
# =============================================================================

print("=" * 88)
print("STEP 6: RUN 100 IMAGES - BASE + BASE LoRA")
print("=" * 88)
print()
...
print("=" * 88)
print("CROPGUARD NEMOTRON 100-IMAGE EVALUATION COMPLETE")
print("=" * 88)
print()
